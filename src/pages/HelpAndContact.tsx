    ...
    <div className="bg-gray-50 min-h-screen font-outfit pb-20">
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center text-xs text-black gap-1">
            ...
            <IoIosArrowForward />
            <span className="text-black font-bold">{t('navigation.helpContact')}</span>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-black mb-4 uppercase tracking-wide">{t('contact.title')}</h1>
        ...
        {/* Contact Section */}
        <div className="bg-white flex flex-col lg:flex-row mb-12">
            {/* Form Side */}
            <div className="w-full lg:w-3/5 p-8 lg:p-12">
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-black mb-2">{t('contact.partnerWithUs')}</h2>
                    <p className="text-black text-md">{t('contact.formDescription')}</p>
                </div>
                
                <form className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input type="email" placeholder={t('contact.emailPlaceholder')} className="w-full border border-gray-300 px-4 py-3 rounded text-sm focus:outline-none focus:border-[#E60013]" />
                        <input type="text" placeholder={t('contact.namePlaceholder')} className="w-full border border-gray-300 px-4 py-3 rounded text-sm focus:outline-none focus:border-[#E60013]" />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                         <input type="text" placeholder={t('contact.whatsappPlaceholder')} className="w-full border border-gray-300 px-4 py-3 rounded text-sm focus:outline-none focus:border-[#E60013]" />
                         <input type="text" placeholder={t('contact.demandedPowerPlaceholder')} className="w-full border border-gray-300 px-4 py-3 rounded text-sm focus:outline-none focus:border-[#E60013]" />
                    </div>
                    <textarea placeholder={t('contact.messagePlaceholder')} rows={4} className="w-full border border-gray-300 px-4 py-3 rounded text-sm focus:outline-none focus:border-[#E60013]"></textarea>
            ...
            <div className="w-full lg:w-2/5 bg-[#3c3c3b] text-white p-8 lg:p-12 flex flex-col justify-center">
                <div className="mb-8">
                    <h3 className="text-lg font-bold mb-4">{t('contact.headquarters')}</h3>
                    <p className="text-white text-md leading-relaxed">
                        {t('contactInfo.headquarterAddress')}
                    </p>
                </div>
                <div>
                     <h3 className="text-lg font-bold mb-4">{t('navigation.helpContact')}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-12">
            {[
                ...
                <div key={idx} className="bg-white px-8 py-10 border border-gray-100 transition-shadow">
                    <h3 className="font-bold text-black text-xl mb-4">{wh.title}</h3>
                    <div className="text-black text-md space-y-2 leading-relaxed font-bold">
