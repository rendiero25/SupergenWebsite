...
const About = () => {
  ...
  const renderContent = () => {
    switch (activeSlug) {
      case "factory-overview":
        return (
          <div>
            <h2 className="text-2xl font-bold mb-8 text-gray-800 text-center uppercase tracking-wide">
        ...
        return (
          <div>
            ...
            <div className="space-y-6 text-black text-md leading-relaxed text-justify mb-8">
              <p>{t("about.corporateDescription1")}</p>
              <p>{t("about.mainProductsTitle")}</p>
              <ul className="list-disc pl-5 space-y-2">
                <li>{t("about.mainProductsList1")}</li>
                <li>{t("about.mainProductsList2")}</li>
              </ul>
              <p>{t("about.corporateDescription2")}</p>
            </div>
  ...
  const getPageTitle = () => {
    switch (activeSlug) {
      case "factory-overview":
        return t("about.factoryOverview");
      case "news-center":
        return t("about.newsCenter");
      case "corporate-profile":
      default:
        return t("about.corporateProfile");
    }
  };
    ...
    <div className="bg-gray min-h-screen font-outfit pb-20">
      ...
      <div className="w-full bg-white">
        <div className="container mx-auto bg-white px-4 md:px-8 lg:px-15 xl:px-15 2xl:px-20 3xl:px-0 py-7 mb-5 flex items-center text-sm text-black gap-1">
          ...
          <IoIosArrowForward />
          <span className="">{getPageTitle()}</span>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-15 xl:px-15 2xl:px-20 3xl:px-0 grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-3">
          <div className="bg-white shadow-sm p-4 sm:p-6 lg:p-8 min-h-[400px] lg:min-h-[500px]">
            {renderContent()}
          </div>
        </div>
      </div>
