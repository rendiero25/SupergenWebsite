...
const Header = () => {
    ...
    Products: [
      {
        ...
        subMenu: [
          {
            label: t("products.openType"),
            path: "/products/generator-set/open-type",
          },
          {
            label: t("products.silentType"),
            path: "/products/generator-set/silent-type",
          },
          {
            label: t("products.containerType"),
            path: "/products/generator-set/container-type",
          },
        ],
      },
      {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-50 bg-white font-outfit shadow-lg h-20">
        <div className="container mx-auto px-4 md:px-8 lg:px-15 xl:px-15 2xl:px-20 3xl:px-0 flex items-stretch justify-between h-full">
          ...
          <div className="flex items-center gap-7 h-full">
            {/* Desktop Navigation */}
            <nav className="hidden xl:flex items-stretch gap-0 h-full">
              {navItems.map((item) => {
            ...
            {/* Search Bar */}
            <div className="hidden xl:flex my-5 items-center border border-gray-300 rounded-full px-4 py-3 w-64 focus-within:border-red-600 transition-colors bg-white">
              <input
                type="text"
                placeholder="Search..."
            ...
            {/* Language Toggle */}
            <div className="relative group my-5 hidden xl:block">
            ...
            <button
              ...
              className="xl:hidden flex items-center justify-center w-10 h-10 text-gray-700 hover:text-red-600 transition-colors"
            >
              {isMobileMenuOpen ? (
      ...
      {/* Mobile Menu Panel */}
      <div
        className={`fixed top-20 right-0 w-80 max-w-full h-[calc(100vh-80px)] bg-white z-40 xl:hidden shadow-xl transform transition-transform duration-300 ease-in-out overflow-y-auto ${
      ...
      >
        <nav className="py-4">
          ...
          <div className="px-6 pb-4 border-b border-gray-100">
            <div className="flex items-center border border-gray-300 rounded-full px-4 py-3 focus-within:border-red-600 transition-colors bg-white">
              <input
                type="text"
                placeholder="Search..."
